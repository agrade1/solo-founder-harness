 ...
 */
import { storeEvidence } from "./evidenceStore.js";
...
const ALLOWED_REGISTRY_HOSTS = ["ui.shadcn.com"];
...
export function assertOfficialRef(ref) {
...
export function assertOfficialSource(source) {
    let host;
    try {
 ...
 */
export function linkInventory(components, availableRefs) {
 ...
 */
export function storeRegistryEvidence(dir, input) {
