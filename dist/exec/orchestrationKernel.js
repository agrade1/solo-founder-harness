...
function launchedProcesses(task) {
    ...
    return (task.execution.priorAttemptProcesses +
...
export class OrchestrationKernel {
    ...
    approvedCodexWorker() {
        ...
        if (auth.codex === null || auth.codex === undefined || auth.codexHome === undefined) {
            throw new OrchestrationError("worker_backend_unapproved", "이 승인에는 codex 리뷰어 권위(executionAuthority.codex + codexHome)가 없다");
        }
