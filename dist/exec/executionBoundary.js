...
function resolveCheckoutRoot(raw, what) {
    ...
    if (!isDir)
        throw new OrchestrationError("boundary_path_not_directory", `${what}는 디렉터리여야 한다: ${raw}`);
    return real;
}
 ...
 */
async function readCheckoutHead(root, what) {
