...
program
  ...
  .action(async (workflowName: string, opts: { project: string; provider: string; maxRegen: string; allowSpawn: boolean; vault?: string; resume: boolean; maxTokens?: string; yes: boolean; toolProfile?: string; bare: boolean; handoff: boolean; cwd?: string }) => {
...
program
  ...
  .action(async (opts: { project: string; cwd?: string; print: boolean; yes: boolean }) => {
