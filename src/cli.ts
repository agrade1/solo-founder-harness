...
program
  ...
  .action(async (workflowName: string, opts: { project: string; provider: string; maxRegen: string; allowSpawn: boolean; vault?: string; resume: boolean; maxTokens?: string; yes: boolean; toolProfile?: string; bare: boolean }) => {
