...
- project: _guide
- created_at: 2026-09-08T04:34:02.049Z
- provider: mock
...
- (7) design: [MOCK] Design Agent (디자인 시스템)의 판단 결과 (실제 LLM 미호출). 역할 관점에서 이 아이디어는 조건부로 진행 가능하다.
- (8) tech_lead: [MOCK] Tech Lead Agent의 판단 결과 (실제 LLM 미호출). 역할 관점에서 이 아이디어는 조건부로 진행 가능하다.
...
- [MOCK] Founder CEO Agent의 판단 결과 (실제 LLM 미호출). 역할 관점에서 이 아이디어는 조건부로 진행 가능하다.

## Key Findings

1. [MOCK] 최종 사업 판단, 진행/축소/검증/보류/폐기 결정 관점의 핵심 발견 1
2. [MOCK] 핵심 발견 2
3. [MOCK] 핵심 발견 3
