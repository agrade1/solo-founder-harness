...
- **live 3 run(claude-code + 실제 Tavily)**: run#1 subcut **killed**(37.5분 · out 133,458) ·
  run#2 shiftpay **killed**(18.7분 · out 61,514) · run#3 commrep 진행 중.
  **B-40 kill 게이트가 live에서 처음 집행됐다** — 체크포인트에 `decision:"killed"`로 기록되고
  ...
  지원사업으로 가격 하한 붕괴). **4단계 완주는 여전히 0회** — 2·3·4단계 live는 미증명이다.
...
- **실측**: 통합본 `npm test` **exit 0** · exec **649/649** · core **646/646**(+12) · acceptance **272/272** ·
  mutation 독립 재현 **3종** · **CLI 스모크 2종**(negative에서 깨진 PRD가 **checkpoints 0**으로 미결박).
- **열린 항목**: A **0** · B **13** · C **103** · id **118**(자기 검증 118 실측).
- **다음 1순위**: `C-125`(설계·Codex triage 완료 — **구현만 남았다**, `docs/handoff/C125_DESIGN.md`) ·
  리서치 어댑터 4건 통합 · live run#3 결과 · `B-44`/`B-43` · `C-123`.
