...
- **실측(전부 단독 실행)**: typecheck 0 · core **703**/0 · exec **658**/0 · acceptance **272**/0.
  **`npm test` 전체 체인도 exit 0**(658 → 703 → 272) — `C-151`의 wrapper 중첩이 실제로 재진입한다는 증거다.
- **대장 126**(등급 A **0**). 이번 세션: `B-47`·`B-48`·`B-64`·`C-151`·`B-51` closed · `C-156` **반증** ·
  `C-158`·`C-159`·`C-160` 신규 · `C-153` 가름 완료 · `C-152` 선행 조건 갱신.
