...
`npm test` → **exec 75 pass / core(=test:core: core+tools+providers+commands) 192 pass / acceptance 71 PASS**, 실패 0. (M3c-1 schema probe scaffold + P0 6건 보완 반영, 2026-07-21)
