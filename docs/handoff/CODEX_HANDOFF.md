...
`npm test` → **exec 75 pass / core(=test:core: core+tools+providers+commands) 208 pass / acceptance 71 PASS**, 실패 0. (M3c-2 read semantics probe scaffold + P0/P1 하드닝 반영, 2026-07-22)
