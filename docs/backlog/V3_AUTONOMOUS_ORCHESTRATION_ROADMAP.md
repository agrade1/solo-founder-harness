...
##### 열린 항목 — id 122건 (등급 A **0** · **등급 B 13** · 등급 C 106 · nonblocking `B-1`/`B-2` 2)
...
C-130 C-131 C-132 C-133 C-134 C-136 C-137 C-139 C-141 C-142 C-143 C-145 C-146 C-147 C-148 C-150 C-151 C-152 C-153
```
